(function e(b, g, d) {
    ...
    1: [function (c, g, a) {
        ...
        var d = b.createClass({
            displayName: "NoCaptcha", render: function () {
                return b.createElement("div", {className: "g-recaptcha", "data-sitekey": h})
            }, componentDidMount: function () {
                var i = {hl: Airbnb.options.language};
                $.getScript(f + "?" + $.param(i))
            }
        });
        g.exports = d
        ...
        a = (function (j) {
            ...
            i.prototype.headline = function () {
                if (this.cameFromMLFinishModal()) {
                    ...
                    if (this.suspended()) {
                        return t("host_standards.rooms.deactivated_flash", {
                            reactivate_link_start: '<a href="/rooms/deactivated">',
                            reactivate_link_end: "</a>",
                            smart_count: 1
                        })
                    } else {
                        if (this.isListed()) {
            ...
            i.prototype.suspended = function () {
                return BootstrapData.get("owner_suspended")
            };
            i.prototype.editUrl = function () {
                return "/manage-listing/" + (this.model.get("id"))
            };
            i.prototype.isListed = function () {
                return this.model.get("has_availability")
            };
            i.prototype.cameFromMLFinishModal = function () {
                return window.location.search.indexOf("preview-finish-modal") !== -1
            };
            i.prototype.cameFromML = function () {
                return window.location.search.match(/preview/)
            };
            i.prototype.isVRPlatformPoweredHost = function () {
                return Airbnb.userAttributes.is_vr_platform_powered_host
            };
            i.prototype.showEditLink = function () {
                return !this.cameFromML() && !this.isVRPlatformPoweredHost() && !this.suspended()
            };
            return i
        })(AIR.Views.BaseView);
        d.exports = a
    }, {"../../../../templates/page3/preview_bar.hbs": 54}],
    3: [function (c, d, b) {
        var g = c("jquery");
        var a = [];
    ...
    4: [function (b, c, a) {
        !(function (j) {
            ...
            function f(l) {
                var n = j(document), m = n.find(".expandable");
                l = l || {};
                m.find(".expandable-content").each(function () {
                    var q = j(this);
                    var o = q.data("threshold") || q.height() * i;
                    var p;
                    p = g(q);
                    if (p <= o) {
                        q.closest(".expandable").addClass("expanded")
                    } else {
                        q.closest(".expandable").data("fullHeight", p)
                    }
                });
                m.find(".expandable-content-full").each(function () {
                    var p = j(this), o = p.closest(".expandable");
                    o.data("fullHeight", g(p));
                    p.css("height", o.find(".expandable-content-summary").height())
                });
                n.on("click", ".expandable-trigger-more", function (p) {
                    var o = j(this).closest(".expandable");
                    if (o.hasClass("expanded")) {
                        return
                    }
                    o.addClass("expanded").find(".expandable-content, .expandable-content-full").css("height", o.data("fullHeight")).afterTransition(function () {
                        j(this).css({transition: "none", height: ""});
                        d(j(this));
                        if (l.callback) {
                            l.callback()
                        }
            ...
            function d(l) {
                var m = l.closest(".row");
                if (m.hasClass("amenities")) {
                    k("amenities")
                } else {
                    if (m.hasClass("description")) {
                        k("description")
                    }
                }
            }
            ...
            function k(l) {
                Airbnb.Tracking.logEvent({
                    ...
                    event_data: {
                        ...
                        page: "p3",
                        section: l,
                        listing_id: window.AirbnbRooms.hostingId,
                        expanded: true
                    }
                })
            }
    ...
    6: [function (g, b, i) {
        ...
        function n(w, u, s) {
            var v = {listing_id: w, month: u, year: s, count: a, _format: "with_conditions"};
            return Airbnb.Api.get(r, {data: v})
        }
    }, {"./util": 13, underscore: "underscore"}],
    7: [function (g, d, R) {
        function Z(ac) {
            return ac && ac.__esModule ? ac : {"default": ac}
        }
        ...
        var B = {};
        var F = {};
        $.fn.calendarDateSpan = function J(ak, ad, aj) {
            var al = this.is("form") ? this : this.find("form:first");
            if (ak === "option") {
                return q(al, ad, aj)
            }
            var ae;
            ...
            U(al, "options", ak);
            Q(ag);
            ae = al.airbnbInputDateSpan(ab.extend({}, ak, {
                getNextDate: M(ai),
                defaults: ab.extend(ak.defaults || {}, {showButtonPanel: true, additionalInfo: y(al, ak)})
            }));
            o(ag, ai);
            h(ac, ai);
            return ae
        ...
        function M(ad) {
            return function ac(ag) {
                var af = new $.Deferred();
                var ah = new Date(ag);
                var ae = m.isoDate(ag);
                X.getDataForMonth(ag, ad).then(function (aj) {
                    var ai = aj.condition_range_map[ae];
        ...
        function N(ac, ae) {
            var ad = ac.data("tooltip-manager");
            if (!ad) {
                return
            }
            if (ae) {
        ...
        function Q(ac) {
            var ad = $.datepicker.parseDate(ac.val());
        ...
        function y(ae, ad) {
            ...
            var ai = W(ae, "month");
            if (ad.lastUpdated) {
                ah = m.fromIsoDate(ad.lastUpdated)
            }
        ...
        function v(ag, af, ac, ad) {
            var ae;
            if (af == null) {
                ae = I18n.t("datepicker_min_nights", {smart_count: ag})
            } else {
                if (af.length === 1) {
                    if (af[0].conditions.min_nights === ag) {
                        ae = I18n.t("datepicker_min_nights", {smart_count: ag})
                    } else {
                        ae = I18n.t("datepicker_min_nights_this_month", {smart_count: ag})
                    }
                } else {
                    ae = I18n.t("datepicker_min_nights_varies")
                }
            }
            return ae
        }
        ...
        function j(ac) {
            return ac.closest("form")
        }

        function W(ad, ac) {
            return j(ad).data("cds-" + ac)
        }

        function U(ad, ac, ae) {
            return j(ad).data("cds-" + ac, ae)
        }

        function n(ac, ad) {
            return W(ac, ad).data("fqUIDatepicker")
        }
        ...
        function o(ac, ad) {
            E(ac, ad, "checkin", C(ac))
        }

        function h(ac, ad) {
            E(ac, ad, "checkout", I(ac))
        }

        function E(ad, ah, af, ae) {
            var ac = 0, ag = new A(ad);
            f(ad, "beforeShow", function () {
                var ai = m.cleanDate($.datepicker.parseDate(ad.val())), aj = ++ac;
                ag.start();
                X.getDataForMonth(ai, ah).then(function (ak) {
                    if (ac === aj) {
                        ae(ak)
                    }
                }).always(function () {
            ...
            f(ad, "onChangeMonthYear", function (aj, ak) {
                var ai = m.cleanDate(new Date()), al = ++ac;
                ai.setDate(1);
                ai.setYear(aj);
                ai.setMonth(ak - 1);
                U(ad, "year", aj);
                U(ad, "month", ak);
                ag.start();
                X.getDataForMonth(ai, ah).then(function (am) {
                    if (ac === al) {
                        ae(am)
                    }
                }).always(function () {
            ...
            f(ad, "onSelect", function () {
                var ak = (0, c["default"])();
                if (!ak) {
                    return
                }
                var al = ad.attr("id");
                if (al != "checkin" || !ad.val()) {
                    return
                }
                var aj = $.datepicker.parseDate(ad.val());
                var ai = $.datepicker.formatDate("yy-mm-dd", aj);
                X.getDataForMonth(aj, ah).then(function (an) {
                    var am = an.condition_range_map;
                    F[aj] = 1;
                    if (am[ai] != null && am[ai].min_nights != null) {
                        F[aj] = am[ai].min_nights
                    }
                    B = {};
                    an.days.forEach(function (ao) {
                        var ap = am[ao.date];
                        V(ap, aj, ao.date, ak)
                    })
                })
            });
            f(ad, "onReset", function () {
                var ai = (0, c["default"])();
                if (!ai) {
                    return
                }
        ...
        function w(ad, ag, af) {
            ...
            f(ad, "onDateMouseEnter", function (ah, aj) {
                var ai = ++ac;
                X.getDataForMonth(ah, ag).then(function (ao) {
                    if (ai !== ac) {
                        return
                    }
                    var ak;
                    var am = m.isoDate(ah);
                    var al = ab.find(ao.days, function (ap) {
                        return ap.date === am
                    });
                    var an;
                    if (al.price) {
                        ak = I18n.priceString(al.price.local_price, al.price.local_currency);
                        an = ae.add(am, ak, aj);
                        an.appendTo($("body"))
                    }
                })
            });
            f(ad, "onDisabledDateMouseEnter", function (ai, ak) {
                var aj = ++ac;
                var ah = W(ad, "options");
                X.getDataForMonth(ai, ag).then(function (an) {
                    if (aj !== ac) {
                        return
                    }
                    if (af === "checkout") {
                    ...
                    var aq = ab.find(an.days, function (ay) {
                        return ay.date === al
                    });
                    ...
                    if (aq.available && !aw) {
                        if (af === "checkin") {
                            if (!G(ar, al)) {
                                ao = K(ar.start_day_of_week);
                                ap = I18n.t("calendar.host_requires_start_day_of_week", {
                                    host_name: ah.hostFirstName,
                                    day_of_week_plural: ao,
                                    line_break: "<br>"
                                })
                            } else {
                                if (!r(ar)) {
                                    ap = I18n.t("calendar.host_requires_no_arrival", {
                                        host_name: ah.hostFirstName,
                                        line_break: "<br>"
                                    })
                                }
                            ...
                            if (af === "checkout") {
                                if (am) {
                                    ap = I18n.t("checkin_noun")
                                } else {
                                    if (!s(ar, al, ax)) {
                                        var au = (0, c["default"])() ? "calendar.host_requires_minimum_nights" : "calendar.host_requires_minimum_nights.original";
                                        ap = I18n.t(au, {
                                            host_name: ah.hostFirstName,
                                            smart_count: b(ar, al),
                                            line_break: "<br>"
                                        ...
                                        if (!p(ar)) {
                                            ap = I18n.t("calendar.host_requires_no_departure", {
                                                host_name: ah.hostFirstName,
                                                line_break: "<br>"
                                            })
                                        }
            ...
            f(ad, "onDateMouseLeave", function (ah) {
                ac++;
                ae.clear()
            });
            f(ad, "onDisabledDateMouseLeave", function (ah) {
                ac++;
                ae.clear()
            });
            f(ad, "onClose", function () {
                ac++;
                ae.clear()
            })
        }
        ...
        function f(ae, ac, af) {
            var ad = ae.datepicker("option", ac);
            ae.datepicker("option", ac, function () {
        ...
        function V(ah, ae, ad, af) {
            if (!af || ah == null) {
                return ah
            }
            if (!F[ae] && !ah.min_nights) {
                return ah
            }
            var ag = O(ad);
        ...
        function b(ad, ac) {
            if (B[ac]) {
                return B[ac].min_nights
            } else {
                return ad.min_nights
            }
        }
        ...
        function a(ag, ai, ah) {
            ...
            var ad = l(ag);
            ai.days.forEach(function (al) {
                var ao = ae[al.date];
                var ak = !al.available;
                var am;
                if (ah === "checkin") {
                    am = G(ao, al.date) && r(ao, al.date)
                } else {
                    if (ah === "checkout") {
                        var an = V(ao, ad, al.date, af);
            ...
            if (af) {
                if (ah == "checkout") {
                    ag.datepicker("option", "checkinDate", ad)
                }
        ...
        function x(ad, ae) {
            var ac = ab.extend({condition_ranges: ae.condition_ranges}, W(ad, "options"));
        ...
        "../../vendor/polyfills/modernizr-touch": 45,
        "./async-spinner": 5,
        "./data": 6,
        "./datePickerExperiment": 8,
        "./tooltip-manager": 10,
        "./util": 13,
        moment: "moment",
        underscore: "underscore"
    ...
    8: [function (b, d, a) {
        ...
        function f() {
            ...
            if (g.getBootstrap("launch_p3_date_picker_experiment")) {
                c = Airbnb.ERF.deliverExperiment("p3_date_picker_experiment", {
                    control: function () {
                        return false
                    }, experiment: function () {
                        return true
                ...
                c = Airbnb.userAttributes.can_see_availability_rules
            }
            return c
        }
    ...
    10: [function (d, f, a) {
        ...
        h.prototype.add = function (j, l, i) {
            var k = new g(i, l, this.id);
            this.tooltips[j] = k;
            if (this.fixed) {
                k.fix()
            }
        ...
        h.prototype.fix = function () {
            this.fixed = true;
            c.each(this.tooltips, function (i) {
                i.fix()
            })
        };
        h.prototype.unfix = function () {
            this.fixed = false;
            c.each(this.tooltips, function (i) {
                i.unfix()
            })
        ...
        h.prototype.clear = function () {
            for (var i in this.tooltips) {
                if (this.tooltips.hasOwnProperty(i)) {
                    this.remove(i)
                }
            }
            $(".datepicker-tooltip-" + this.id).remove()
        }
    }, {"./tooltip": 12, underscore: "underscore"}],
    11: [function (c, d, a) {
        var b = c("hbsfy/runtime");
        d.exports = b.template(function (h, o, g, n, m) {
    ...
    12: [function (c, d, b) {
        ...
        function a(l) {
            var j = l.$target, k = l.$el, n = j.offset(), i = "absolute", m = n.top - (k.height() + 11);
            l.fix();
            if (l._fixed) {
                m -= $(window).scrollTop();
                i = "fixed"
    ...
    13: [function (c, d, b) {
        ...
        var a = {
            isoDate: function (g) {
                ...
                if (j > 0) {
                    return I18n.t("datepicker_updated_years_ago", {smart_count: j})
                }
                if (i > 0) {
                    return I18n.t("datepicker_updated_months_ago", {smart_count: i})
                }
                if (h > 0) {
                    return I18n.t("datepicker_updated_days_ago", {smart_count: h})
                }
    ...
    14: [function (c, f, b) {
        ...
        var h = (function () {
            ...
            d(m, [{
                key: "logInitialImpression", value: function j() {
                ...
                key: "initTimers", value: function l() {
                    var p = this;
                    this.timers = this.timeIntervals.map(function (q) {
                        return new a(q * 1000, function () {
                            Airbnb.Tracking.logEvent({
                                event_name: p.airEventData.event_name,
                                event_data: {
                                    operation: "duration",
                                    page: p.airEventData.event_data.page,
                                    duration_uuid: p.timestamp,
                                    page_view_duration: q
                                }
                            })
                        })
                    });
                    this.timers.forEach(function (q) {
                        return q.start()
                    })
                }
            }, {
                key: "initVisiblityChangeEvent", value: function o() {
                    $(window).on("blur", this.onHide.bind(this));
                    $(window).on("focus", this.onShow.bind(this))
                }
            }, {
                key: "onShow", value: function n() {
                    this.timers.forEach(function (p) {
                        return p.resume()
                    })
                }
            }, {
                key: "onHide", value: function i() {
                    this.timers.forEach(function (p) {
                        return p.pause()
                    })
                }
            }, {
                key: "isNewTab", value: function k() {
    ...
    15: [function (c, d, a) {
        var g = c("backbone"), b = "/locations/api/neighborhood_tiles.json?", f = g.Model.extend({
            parse: function (h) {
    ...
    16: [function (b, c, a) {
        ...
        c.exports = {
            init: function () {
                ...
                this.hasOffer = false;
                if (g.getBootstrap("book_it_color_experiment_v2")) {
                    this.bookItBtnClass = d.ERF.deliverExperiment("book_it_color_experiment_v2", {
                        control: function () {
                            return "btn-primary"
                        }, babu: function () {
                            return "book-it-btn-experiment-babu"
                        }, lima: function () {
                            return "book-it-btn-experiment-lima"
                        }, kazan: function () {
                            return "book-it-btn-experiment-kazan"
                        }, treatment_unknown: function () {
                            return "btn-primary"
                        }
                    })
                }
                f(".js-book-it-btn").on("click", function (i) {
                    d.Tracking.queueEvent({
                        event_name: "book_it_color_experiment_v2",
                        event_data: {
                            section: "book_it_color_experiment_v2",
                            page: "p3",
                            operation: "click",
                            treatment: h.bookItBtnClass,
                            hostingId: AirbnbRooms.hostingId
                        }
                    })
                });
                f(this.updateButton());
                ...
                if (!this.hasOffer) {
                    f(".js-book-it-btn").removeClass("btn-primary");
    ...
    17: [function (b, c, a) {
        ...
        c.exports = {
            init: function () {
                var g = this;
                d.ERF.deliverExperiment("p3_safety_features_section", {
                    control: function () {
                    }, treatment1: function () {
                        return g.isT1 = true
                    }, treatment2: function () {
                ...
                f(function () {
                    return g.updateUiForExperiment()
                })
            }, updateUiForExperiment: function () {
                var g = f(".js-p3-safety-features-section");
                if (this.isT1 || this.isT2) {
                    f(".js-safety-feature").addClass("hide");
                    if (this.isT1) {
                        g.find("del").remove();
                        if (g.find(".js-present-safety-feature").length === 0) {
                            g.find(".js-no-safety-features-text").removeClass("hide")
                        }
                    }
                    g.removeClass("hide")
                }
        ...
        function d(i) {
            ...
            $(document).one("keypress", function (j) {
                ...
                switch (j.which) {
                    ...
                    case 50:
                    case 51:
                        $("body").animate({scrollTop: $("#admin-placeholder").offset().top});
                        break
                }
            });
            var f = function () {
                $.get("/rooms/ajax_admin_footer", {hosting_id: i}, function (k, j) {
                    if (j === "success") {
    ...
    19: [function (d, b, f) {
        ...
        g = {
            init: function () {
                ...
                return this.refresh
            }, firstTimeSubtotalDisplay: true, refresh: function (x) {
                var p = $(".js-subtotal-container"), y = $("#checkin").val(), q = $("#checkout").val(), w = $("#number_of_guests").val(), u = $.query.load(window.location.href).keys, r = {}, l;
                if (a === y && h === q && j === w) {
                    if (!x) {
                        return
                    }
                ...
                j = w;
                function v(z) {
                    Airbnb.mediator.emit("p3::refreshSubtotal", z);
                    AirbnbRooms.updateAirEvent({
                        avg_price: z.price_per_night_usd,
                        native_avg_price: z.price_per_night_native,
                        total_price: z.total_price_usd,
                        native_total_price: z.total_price_native,
                        service_fee: z.service_fee_usd,
                        include_service_fee: z.include_service_fee,
                        tax_amount: z.tax_amount,
                        tax_descriptions: z.tax_descriptions,
                        available: z.available,
                        instant_book_possible: z.can_instant_book,
                        currency: z.currency,
                        checkin_date: $.datepicker.formatDate("yy-mm-dd", $.datepicker.parseDate(y)),
                        checkout_date: $.datepicker.formatDate("yy-mm-dd", $.datepicker.parseDate(q)),
                        nights: z.nights,
                        guests: w
                    });
                ...
                if (u.guests !== r.guests || u.checkin !== r.checkin || u.checkout !== r.checkout) {
                    if (g.hasPushState) {
                        var o = function () {
                        ...
                        Airbnb.ERF.deliverExperiment("p3_history_replace_state", {
                            control: o,
                            use_replace_state: n,
                            treatment_unknown: o,
                            not_in_experiment: o
                ...
                if (y && q) {
                    $(".js-book-it-btn").removeAttr("disabled");
                    $(".js-book-it-status").addClass("loading");
                    var m = $("#book_it_form").serializeArray();
                    if (this.firstTimeSubtotalDisplay && u.s && u.checkin && u.checkout) {
                        var s = $.datepicker.formatDate("yy-mm-dd", $.datepicker.parseDate(u.checkin));
    ...
    20: [function (b, c, a) {
        (function (m, i, h) {
            ...
            if (typeof c !== "undefined") {
                ...
                l = {
                    template: b("../../../templates/page3/slideshow_image.hbs"),
                    preloadTemplate: b("../../../templates/page3/slideshow_image_preload.hbs")
                }
            } else {
                k = enderRequire("simple_iterator");
            ...
            m.extend(j.prototype, {
                ...
                _panel: null,
                _currentLeft: 0,
                _options: {extraSpacing: {left: 0, right: 0}},
                showInViewport: function (s) {
                    var n = s.position(), v = this._options.thumbnailWidth || s.width(), p = this._viewport.width(), u = this._panel.width(), r = n.left + (v - p) / 2 + 10, o = 0, q = u - p;
                    if (p >= u) {
                        return
                    }
                    if (r >= 0 && r <= q) {
            ...
            f = function (v, x) {
                var p, r, u, q, s, o, w = this;
                var n = undefined;
                if (i("#photo-social-share-widget").length > 0 && i(".hide-sm").is(":visible") && Airbnb.ERF.deliverExperiment("p3_photo_sharing", {
                        sharing_above_photos: function () {
                            return true
                        }, no_photo_sharing: function () {
                            return false
                        }, treatment_unknown: function () {
                            return false
                        }
                ...
                o = i.makeArray(this._$thumbnails.find("li a").map(function (y) {
                    var z = i(this);
                    return {url: z.attr("href"), caption: z.attr("title"), index: y}
                }));
                this._list = new k(o, {
                    onChange: function (D, F, G) {
                        var H = p.find(".active"), B = w._$thumbnails.find(".active"), I, C = w._$slideshow.data("preload-size") || 1, E, A, y = [];
                        p.find("li:not(.active)").html(q(m.extend({}, D, w._options.size))).addClass("active").insertBefore(H);
                        H.removeClass("active");
                        if (n) {
                            i(".img-contain .social-share-widget").remove();
                        ...
                        if (u.length && s) {
                            for (E = 0;
                                 ...
                                 ++E) {
                                A = (F + E + 1) % o.length;
                                if (!i("#slideshow-preload-" + A).length) {
                                    y.push(this.peek(A))
                                }
                            }
                            if (y.length) {
                        ...
                        if (w._options.onChange) {
                            w._options.onChange(D, F, G)
                        }
                    }
                });
                this.toIndex(0);
            ...
            m.extend(f.prototype, {
                ...
                _list: null,
                _slidingPanel: null,
                _options: {size: {}, template: null, preloadTemplate: null},
                _attachClickHandlers: function () {
                    var n = this;
                    this._$thumbnails.on("click", "li a", function (p) {
                        p.preventDefault();
                        var o = n._$thumbnails.find("li").index(i(this).parent());
                        n.toIndex(o, this)
                    });
                    this._$slideshow.on("click", "[data-slideshow-prev]", function (o) {
                        o.preventDefault();
                        n.previous(this)
                    });
                    this._$slideshow.on("click", "[data-slideshow-next]", function (o) {
                        o.preventDefault();
                        if (i(o.target).parents(".p3-photo-social-share-widget").length === 0) {
                            n.next(this)
                        }
                    })
                },
                ...
                _attachKeyboardHandlers: function () {
                    var o = this, n = function (p) {
                        switch (p.which) {
                            case 37:
                                o.previous("keyboardLeft");
                                break;
                            case 39:
                                o.next("keyboardRight");
                                break
                        }
                    };
                ...
                previous: function (n) {
                    this._list.previous(n)
                },
                toIndex: function (n, o) {
                    this._list.toIndex(n, o)
                }
            });
            function g(o, n) {
                var p = n[o];
        ...
        "../../../templates/page3/slideshow_image.hbs": 55,
        "../../../templates/page3/slideshow_image_preload.hbs": 56,
        "../../simple_iterator": 41,
        "../../views/shared/social/social_share_widget": 49
    }],
    21: [function (b, c, a) {
        c.exports = d;
        function d() {
    ...
    22: [function (c, d, a) {
        var b = c("underscore");
        var f = {
            staggered: false, init: function (o) {
                var k = this;
                ...
                $.getJSON("/rooms/" + o.hostingId + "/personalization.json", {review_ids: m}, function (p) {
                    $.extend(p, h);
                ...
                l.map(function (p) {
                    $(p[0]).on("click", function () {
                        Airbnb.Tracking.logEvent({
                            event_name: p[1],
                            event_data: {action: "click", hosting_id: AirbnbRooms.hostingId}
                        })
                    })
                });
                ...
                Airbnb.WishListButton.init({placement: "page3", tooltipOptions: {showLimit: 2}})
                ...
                if (k) {
                    var j = $("#description_text_wrapper"), g = k.find(".translate_button_label"), i = k.find(".gBrandingText"), m = j.html(), l = false;
                    k.click(function () {
                        if (l) {
                            l = false;
        ...
        d.exports = f
    }, {"../lib/airbnb/expandable": 4, "./admin": 18, underscore: "underscore"}],
    23: [function (l, d, y) {
        function a(z) {
        ...
        function g(z) {
            ...
            this.initialize = function (C) {
                ...
                this.bookItView = new j({
                    el: $("#book_it_form"),
                    hostingId: C.hostingId,
                    minNights: C.minNights,
                    calendarLastUpdated: C.calendarLastUpdated,
                    nightly_price: C.nightly_price,
                    staggered_price: C.staggered_price,
                    isMonthly: C.isMonthly,
                    hostFirstName: C.hostFirstName
                });
                ...
                $("#sticky-md-book-it-btn").on("click", (function (D) {
                    B(D);
            ...
            this.initShareWidget = function () {
                var C = $(".p3-share-widget");
                var E = 4;
                if ($("#p3-sharing-module").length > 0) {
                    var D = Airbnb.ERF.deliverExperiment("p3_sharing_module", {
                        control: function () {
                            return "control"
                        }, rounded_icons: function () {
                            return "rounded_icons"
                        }, boxed_icons: function () {
                            return "boxed_icons"
                        }, treatment_unknown: function () {
                            return "control"
                        }
                    ...
                    if (D === "rounded_icons") {
                        ...
                        if (D === "boxed_icons") {
                            ...
                            C.find(".share-triggers").replaceWith(function () {
                                return $("<div/>", {"class": "share-triggers btn-group", html: this.innerHTML})
                            });
                            C.find("a").slice(0, 2).addClass("text-center btn").each(function (G, F) {
                                var H = $(F);
            ...
            this.setupBindings = function () {
                ...
                $("#host-profile-contact-btn, #contact-host-link").on("click", function (E) {
                    var D = $(C).is("#contact-host-link") ? "CONTACT_HOST_LINK" : "CONTACT_HOST";
                    if (!Airbnb.Utils.isUserLoggedIn) {
                        C.contactHostLogging({section: D, step: "clicked_contact", action: "click"});
            ...
            this.launchSignupOrLoginModal = function (C, E, D) {
                var F = function () {
                    A.contactHostLogging({section: "signup_login_modal", step: "logged_in", action: "submit"});
                    A.contactHostHandler(E, D)
                };
                if (C === "login") {
                    Airbnb.SignupLoginModal.launchLogin({callback: F, flow: "contact-host"})
                } else {
                    if (C === "signup") {
                        Airbnb.SignupLoginModal.launchSignup({callback: F, flow: "contact-host"})
                    }
                }
            };
            this.doPersonalization = function (F) {
                var C;
                var D;
                var E;
                var H;
                if (F.is_owned_by_user) {
                    $(".superhost-tooltip-other, .superhost-tooltip-self").toggleClass("hide");
                    $(".response-details").toggleClass("hide")
                } else {
                    if (Airbnb.Utils.isUserLoggedIn) {
                        var G = $("#flag-modal-container");
                        new window.UserFlag(F.flag_info, G)
                    }
                }
                if (F.listing_attributes) {
            ...
            this.initPreviouslyMessaged = function (C) {
                var D;
                if (C) {
                    C.message = C.replied_last ? t("interactionContacted", {date: C.date}) : t("interactionReceived", {date: C.date});
                    ...
                    if (C.hasOffer) {
                        $(".js-book-it-btn").removeClass("btn-primary");
                        Airbnb.mediator.emit("p3::receivedOfferState")
                    }
                }
            };
            this.contactHostHandler = function (D, C) {
            ...
            this.contactHostLogging = function (D) {
                var C = this.getP3ContactHostEventData(D.section, D.action);
                if (D.step) {
                    $.extend(C.event_data, {step: D.step})
                }
                Airbnb.Tracking.logEvent(C)
            };
            this.loadContactHostModal = function () {
                var C = l("./views/contact_host_modal");
                if (!this.contactHostModal) {
                    this.contactHostModal = new C({
            ...
            this.getP3ContactHostEventData = function (D, C) {
                return {
                    ...
                    event_data: {
                        ...
                        section: D,
                        action: C,
                        listing_id: A.options.hostingId,
                        is_instant_bookable: AirbnbRooms.ibData.is_instant_bookable
                    }
                }
            };
            this.setUpTimeSpentOnPage = function (C) {
                var D = new k({airEventData: C, timeIntervals: [1, 5, 10, 30, 60, 120, 240, 300, 600, 1800, 3600]})
            };
            this.initialize(z)
        }
        ...
        "../../templates/page3/interaction.hbs": 51,
        "../apps/manage_listing/views/preview_bar": 2,
        "../lib/airbnb/expandable": 4,
        "../logging/page_impression_logger": 14,
        "../views/shared/social/social_share_widget": 49,
        "./hca_contact_me": 21,
        "./utils": 27,
        "./views/book_it": 28,
        "./views/contact_host_modal": 31,
        "./views/details": 32,
        "./views/host_profile": 33,
        "./views/location": 34,
        "./views/photos": 36,
        "./views/reviews": 37,
        "./views/similar_listings": 38,
        backbone: "backbone",
        o2: "o2",
        underscore: "underscore"
    }],
    24: [function (c, d, a) {
        ...
        f.prototype.addTrackingContext = function () {
            var g = b.extend({listing_id: AirbnbRooms.options.hostingId}, this.options.tracking_context);
    ...
    25: [function (g, i, d) {
        var c = "p3/question_saver/question";
        var h = 2000;
        var f = g("underscore");
        ...
        a.prototype.onChangeQuestion = f.debounce(function (j) {
            this.saveQuestion(j.currentTarget.value)
        }, 100);
        a.prototype.saveQuestion = function (j) {
            if (j.length > h) {
                j = j.slice(0, h)
            }
            b.store(c, j)
    ...
    26: [function (d, b, j) {
        ...
        function i(s, u, x, y) {
            var p = Math.round(x * 100000), r = Math.round(s * 100000), z = Math.round(y * 100000), q = Math.round(u * 100000), w = z - q, v = p - r;
            return l(v) + l(w)
        }
        ...
        function a(p, q, y) {
            var w = y / 6371, x = h(q), s = h(p.lat), v = h(p.lng), r = Math.asin(Math.sin(s) * Math.cos(w) + Math.cos(s) * Math.sin(w) * Math.cos(x)), u = v + Math.atan2(Math.sin(x) * Math.sin(w) * Math.cos(s), Math.cos(w) - Math.sin(s) * Math.sin(r));
            if (isNaN(r) || isNaN(u)) {
                return null
            }
    ...
    27: [function (b, c, a) {
        var d = {
            translate: function (g) {
                var j = $("#description_text_wrapper"), i = j.attr("data-machine-translation"), l = $("#new_translate_button_wrapper"), f = l.find(".translate_button_label"), h = l.find(".gBrandingText"), m = j.attr("data-display-lang");
                Airbnb.Tracking.logEvent({
                ...
                var j = $("#review-translate-button-wrapper"), f = j.find(".review_translate_button_label"), h = j.find(".gBrandingText");
                ...
                Airbnb.Tracking.logEvent({
                    ...
                    event_data: {user_lang: g, hosting_id: AirbnbRooms.hostingId}
                });
                ...
                var f = this.formatDate($("#checkin").val()), i = this.formatDate($("#checkout").val()), j = $("#view_other_listings_button").data("reasonCode"), h = {
                    event_name: "listing_view",
                    event_data: {
                        operation: "click",
                        page: "p3",
                ...
                try {
                    ...
                    if (j.length > 0) {
                        Airbnb.Tracking.logEvent({event_name: "resource_timing", event_data: {page: "p3", payload: j}})
                    }
                } catch (k) {
                }
            }
    ...
    28: [function (f, b, k) {
        var n = f("backbone"), g = f("o2-flash"), o = f("underscore"), c = f("o2"), m = f("./book_it/price_refresher"), d = f("../globals/refresh_subtotal"), l, a, p, i = [];
        var h = f("./book_it_messaging_view");
        l = {
            initialize: function (q) {
                c.matchMedia.on("lg", (function (r) {
                ...
                var q = this;
                Airbnb.ERF.deliverExperiment("p2_p3_encourage_dates_messaging_v2", {
                    control: function () {
                    }, simple_message: function () {
                        q.showSimpleDatesMessage = true
                    }, illustration_and_message: function () {
                        q.showIllustrationDatesMessage = true
                    }, treatment_unknown: function () {
                    }
                })
            ...
            }, showEncourageDatesMessage: function (q) {
                if (this.showSimpleDatesMessage) {
                    $(".simple-dates-message-container").toggleClass("hide", q !== undefined)
                } else {
                    if (this.showIllustrationDatesMessage) {
                        $(".fancy-dates-message-container").toggleClass("hide", q !== undefined)
                    }
                }
            }, onDatesChanged: function (r) {
                var q = $.query.load(window.location.href).keys.checkin;
                this.showEncourageDatesMessage(q)
            }, onPersonalization: function (v) {
                var r = $.query.load(window.location.href).keys, u = r.checkin, s = r.checkout;
                ...
                if (v.should_hide_action_buttons) {
                    $(".js-book-it-status").addClass("hide");
            ...
            }, events: {"change #number_of_guests": "refreshSubtotal"}, setInstantBookable: function (q) {
                $("#book_it_form").toggleClass("book-it--instant", q);
                if (typeof this.inP3FriendlierIbCta === "undefined") {
                    this.inP3FriendlierIbCta = Airbnb.ERF.deliverExperiment("p3_friendlier_ib_cta", {
                        control: function () {
                            return false
                        }, friendlier_ib_cta: function () {
                            return true
                        }, treatment_unknown: function () {
                            return false
                ...
                var s = $.query.load(window.location.href).keys, v = s.checkin, u = s.checkout, x = s.guests, w;
                if (v) {
                ...
                var K = this.$el, M = $("#summary"), N = $("#host-profile"), E = $(window), I = $("#book_it"), G = $("#pricing"), O = $("#checkin"), x = $("#checkout"), J = this.$(".other-actions"), B = $(".flag-trigger"), s = 40, C, y, w, u, F = false, r = false, q = false, v, D, A, z;
                    ...
                    if (P >= s * -1) {
                        ...
                        if (R > w) {
                            ...
                            if (!I.hasClass("fixed")) {
                                ...
                                if (!B.hasClass("hide") && $(".p3-share-widget.rounded-icons").length === 0) {
                                    B.hide()
                                }
                            }
                        }
        ...
        "../globals/refresh_subtotal": 19,
        "./book_it/price_refresher": 29,
        "./book_it_messaging_view": 30,
        backbone: "backbone",
        o2: "o2",
        "o2-flash": "o2-flash",
        underscore: "underscore"
    ...
    29: [function (c, b, f) {
        ...
        var a = {
            refreshSubtotal: function () {
            ...
            }, setPrice: function (k, l) {
                $(".book-it-price-amount").html(k);
                $(".js-subtotal-container").toggleClass("hide", !l);
                $(".per-night").toggleClass("hide", !l);
                $(".per-month").toggleClass("hide", l)
            }, setPriceFromData: function (m) {
                var k = $("#price_amount"), l, n;
                if (m.staggered || this.isMonthly) {
                    l = m.staggered_price;
                    n = false
                } else {
                    l = m.price_per_night || m.nightly_price;
                    n = true
                }
                this.setPrice(l, n);
                $("#per_month .icon").toggleClass("hide", n || !m.available)
            }, resetPrice: function () {
                var k = this.isMonthly ? this.defaultStaggeredPrice : this.defaultNightlyPrice;
                this.setPrice(k, !this.isMonthly)
            }, onSubtotalRefresh: function (n) {
                var p = $("#tax-descriptions-tip"), k = !$("#checkin").val() || !$("#checkout").val(), m = n && !!n.available, o = n && n.tax_amount_native > 0, l = $(".js-book-it-status");
                ...
                if (n.available) {
                    this.setPriceFromData(n);
                    if (n.staggered) {
                        $(".js-subtotal-container").addClass("hide");
                        $("#monthly-breakdown").html(JST["p4/partials/monthly_billing_breakdown"]({
                            tax_descriptions: n.tax_descriptions,
                            subtotal: n.accommodations,
                            guest_pays_vat: n.guest_pays_vat,
                            service_fee: n.service_fee,
                            taxes: I18n.priceString(n.tax_amount_native),
                            show_tax_data: o
                        }))
                    } else {
                        l.removeClass("panel-body");
                        g(n);
                        if (o) {
                            p.html(JST["p4/partials/tax_descriptions"]({tax_descriptions: n.tax_descriptions}))
                        }
                    }
        ...
        f["default"] = a;
        function g(m) {
            var n = $("#tax-descriptions-tip"), k = $("#service-fee-tip"), l;
            l = [{
                description: I18n.t("Price per night x nights", {
                    basePricePerNight: m.price_per_night,
                    smart_count: m.nights
                }), value: m.subtotal
            }];
            if (m.extras_price) {
                l.push({description: I18n.t("Cleaning fee"), value: m.extras_price})
            }
            if (m.service_fee) {
                if (m.guest_pays_vat) {
                    ...
                    if (m.service_tooltip_experiment) {
                        $(".fee-no-vat-tooltip").addClass("hide");
                ...
                l.push({
                    ...
                    tooltip: {id: "service-fee-tooltip"},
                    value: m.service_fee
                });
                if (k && k.data()) {
            ...
            if (m.tax_amount_native > 0) {
                l.push({
                    description: I18n.t("occupancy_taxes"),
                    tooltip: {id: "tax-descriptions-tooltip"},
                    value: I18n.priceString(m.tax_amount_native)
                });
                if (n && n.data()) {
                    n.data()["o2-tooltip"] = undefined
                }
            }
            $(".js-subtotal-container").addClass("panel-padding-fit").removeClass("hide").html((0, d["default"])({
                components: l,
                total: {description: I18n.t("Total"), value: m.total_price_with_fees}
            }));
            h.Tooltip.bind()
        }

        b.exports = f["default"]
    }, {"../../../../templates/page3/subtotal.hbs": 59, o2: "o2"}],
    30: [function (d, f, b) {
        var g = d("backbone");
        var c = d("underscore");
        var a = g.View.extend({
            initialize: function (h) {
                ...
                Airbnb.mediator.on("p3::dateGuestChange", this.onDatesChanged.bind(this))
            }, calculateAnimationScrollPosition: function () {
                if (this.$el.offset().top > 0) {
                    this.animationScrollPosition = this.$el.offset().top + window.innerHeight / 3
                }
            }, toggleMessageView: function () {
                if (this.animationScrollPosition && this.animationScrollPosition < this.scrollBottom) {
                    this.$el.addClass("expanded");
                    if (!this.sentNotification) {
                        Airbnb.Tracking.logEvent({
                            event_name: "p3_uc_message",
                            event_data: {operation: "impression", message_type: this.messageData.message_type}
                        });
                        this.sentNotification = true
                    }
                } else {
                    if (this.$el.offset().top > this.scrollBottom) {
                ...
                if (!this._animFrameRequested) {
                    this._animFrameRequested = true;
                    if (window.requestAnimationFrame) {
                        window.requestAnimationFrame(this.toggleMessageView.bind(this))
                    } else {
                        this.toggleMessageView.call(this)
                    }
                }
                ...
                i.addClass("hide");
                if (this.messageData.message_type === "dated_views") {
                    $('[data-behavior="dated_views_body"]').text(this.messageData.dated_views_body_text)
                }
                var h = $('[data-behavior="' + this.messageData.message_type + '"]');
                h.removeClass("hide");
                this.handleScroll()
            }, deliverExperiment: function () {
                if (this.hasDates && this.messageData) {
                    if (this.shouldShowMessaging) {
                        this.showMessaging()
                    } else {
                        if (this.shouldShowMessaging === undefined) {
            ...
            }, onDatesChanged: function (h) {
                if (h) {
                    this.hasDates = !!h.checkin && !!h.checkout;
                    this.deliverExperiment()
                }
            }, onPriceChange: function (h) {
                if (h) {
                    if (h.p3_message_data) {
                        this.messageData = h.p3_message_data
                    }
                    this.deliverExperiment()
                }
            }
    ...
    31: [function (l, b, D) {
        var w = l("o2"), c = w.Tabs, a = w.Modal, C = l("../utils"), q = l("../shared/p3_upsell"), z = l("../shared/question_saver"), r = l("react");
        ...
        i.prototype.initializeModal = function () {
            var E = "#contact-modal", F = $(E).data("o2-modal");
            if (F === undefined) {
                F = new a(E)
            }
            F.on("close", d);
        ...
        i.prototype.insertContent = function (E) {
            this.$content.html(E);
        ...
        i.prototype.initCaptcha = function () {
            var F = r.createFactory(l("../../NoCaptcha.jsx"));
        ...
        i.prototype.setLoading = function (E) {
            this.$content.toggleClass("loading", E)
        };
        i.prototype.initSavedQuestion = function () {
            var E = this.questionSaver.getSavedQuestion();
            if (E) {
                $("#question").val(E)
            }
        };
        i.prototype.onChangeQuestion = function (E) {
            this.questionSaver.onChangeQuestion(E)
        };
        function f(E) {
            alert(E)
        }
        ...
        function k(K) {
            ...
            if (F.getTime() - N.getTime() > 32000000000) {
        ...
        function n() {
            var E = $("#question").removeAttr("disabled");
        ...
        function x() {
            var E = $.datepicker._defaults.dateFormat, G = $("#message_checkin").val(), F = $("#message_checkout").val(), I = $("#message_number_of_guests").val(), H;
            Flash.clear();
            j();
            if (G === E || F === E) {
                return false
            ...
            $.getJSON(check_dates_url, H, function (J) {
                p();
                if (J.available) {
                    n()
                } else {
        ...
        function o(F, E) {
            $("#dates_other_error").html("<strong>" + F + "</strong> " + (E || ""))
        }
        ...
        function A(H) {
            ...
            H.setLoading(true);
            $.post(I, J.serialize(), function (M) {
                var K = new q(M.upsell_presenter);
                if (M.is_logged_in) {
                    Airbnb.SignInUp.broadcastLogin({refresh: false})
                }
                if (M.message === "") {
                    Airbnb.doConversions();
                    H.questionSaver.clearSavedQuestion();
                    m();
                    if (M.show_verified_id_upsell) {
                        B("#verified-id-container")
                    } else {
                        if (M.show_profile_pic_upsell) {
                            H.close();
                            u(M)
                        } else {
                            if (K.shouldShowIBTreatment()) {
                                B("#p3-upsell-treatment")
                            } else {
                                if (K.shouldShowReservationTreatment()) {
                                    B("#p3-reservation-upsell-treatment")
                                } else {
                                    if (M.has_contacted_host) {
                                        B("#invite-friends")
                                    } else {
                                        B("#multi-messaging")
                                    }
        ...
        function B(E) {
            $(".contact-host-panel").addClass("hide").filter(E).removeClass("hide")
        }

        function u(E) {
            Airbnb.mediator.emit("guestOnboarding::profilePicUpsell", function () {
                var G = window.enderRequire("profile_pic_upsell/upsell_modal");
                var F = new G({
                    tracking_event_name: "contact_host_profile_pic_upsell_modal",
                    flow: "contact_host_profile_pic_upsell",
                    isNewbie: E.is_newbie,
                    showWeiboButton: E.show_weibo_button,
                    showFacebookButton: E.show_facebook_button,
                    showGoogleButton: E.show_google_button,
        ...
        function d() {
            Airbnb.mediator.emit("p3::contactHostLogging", {section: "contact_host_modal", action: "close"})
        }

        b.exports = i
    }, {
        "../../NoCaptcha.jsx": 1,
        "../../verification_flow.js": 46,
        "../shared/p3_upsell": 24,
        "../shared/question_saver": 25,
        "../utils": 27,
        o2: "o2",
        react: "react"
    }],
    ...
    33: [function (c, a, d) {
        ...
        var i = j(g);
        var f = h["default"].View.extend({
            initialize: function () {
                var k = this;
                Airbnb.mediator.on("p3::personalize", function (l) {
                    k.initSocialConnections(l.social_connections, l.show_fb_cta);
                    if (l.should_hide_action_buttons) {
                        $("#contact_wrapper").addClass("hide")
                    }
                })
            }, initSocialConnections: function (p, n) {
                var k = 2, u = p.relationships, l = u && u.length, o = p.connected, s = this.$(".social-connections-section"), q, r, v, m;
                if (!o && n) {
                    s.find(".facebook-button-wrapper").addBack().removeClass("hide");
                    s.find(".fb-button").click(function (w) {
                        var x = $(this);
                ...
                if (l) {
                    r = s.find(".social-connections-list");
                    for (q = 0;
                         q < Math.min(k, l);
                         q++) {
                        r.append((0, i["default"])(u[q]))
                    }
                    if (l > k) {
                        v = s.find(".more-connections-link").removeClass("hide");
                        m = s.find("#more-count").html(l - k);
                        v.one("click", function (w) {
                            for (q = k;
                                 q < l;
                                 q++) {
                                r.append((0, i["default"])(u[q]))
        ...
        d["default"] = f;
        a.exports = d["default"]
    }, {"../../../templates/page3/social_connection.hbs": 58, backbone: "backbone"}],
    34: [function (d, a, g) {
        function o(p) {
        ...
        n = l.View.extend({
            initialize: function () {
                m.bindAll(this, "handleItemChange", "initNeighborhood");
                Airbnb.mediator.on("p3::lazyLoadSections", (function () {
                    ...
                    $.when(this.mapDeferred, this.neighborhoodDeferred).then(function () {
                        q.addNeighborhoodPolygonToMap();
                        if (q.isTabletOrPhone && !q.isAlternateMapProvider) {
                            $(window).on("resize", m.debounce(q.addNeighborhoodPolygonToMap.bind(q), 500))
                        }
                    }, function () {
                        q.mapDeferred.done(function () {
                            if (q.isTabletOrPhone && !q.isAlternateMapProvider) {
                                q.addStaticGoogleMap();
                                $(window).on("resize", m.debounce(q.addStaticGoogleMap.bind(q), 500))
                            }
                        })
                    })
                }).bind(this))
            }, handleItemChange: function (p) {
                var q = this.$(".dot");
                ...
                this.staticMapHelpers = new i();
                this.staticMapUrl = this.generateStaticMapUrl();
                this.mapDeferred.resolve()
            }, initNeighborhood: function () {
                if (this.containsNeighborhood) {
                    this.model = new f({id: this.$neighborhoodElem.data("neighborhood-id")});
                    this.model.fetch({
                        success: (function (p) {
                            this.$neighborhoodElem.attr("href", p.get("url"));
                ...
                var p = [];
                if (q.hasThumbnails()) {
                    $.each(this.model.get("tags"), function (u, v) {
                        p.push(v.name)
                    });
                    $("#neighborhood-seo-link").remove();
                    $("#hover-card").prepend((0, j["default"])({
                        tags: p.join(r),
                        name: q.get("name"),
                        topline: q.get("topline"),
                        url: q.get("url"),
                        thumbnails: q.get("thumbnails"),
                        launched: q.get("launched")
                    }));
                ...
                var q = this.model.get("bounds"), r = [], p = {};
                if (q && q.coordinates && q.coordinates[0] && q.coordinates[0][0]) {
                    m.each(q.coordinates[0][0], function (u, s) {
                        r.push({lat: u[1], lng: u[0]})
                    });
                ...
                var q = this.getNeighborhoodPolygonToGoogle();
                var w = {
                    color: q.strokeColor.replace("#", "0x"),
                    fillcolor: q.fillColor.replace("#", "0x") + "33",
                    weight: q.strokeWeight
                }, v = this.staticMapHelpers.createEncodedPath(q.paths, w), u = encodeURIComponent(this.staticMapUrl).length + encodeURIComponent(v).length, r = 2048, s = 30, p = 54;
                if (u + p + s < r) {
                    return v
                }
                return ""
                ...
                }, q = window.AirbnbConstants.MapCircleSizes[14] / 1000, p = this.staticMapHelpers.getOffsetCenterParams(v, q), s = [], u = this.staticMapHelpers.createCircleAroundPoint(v, q), w = {
                    color: window.AirbnbConstants.GoogleMapCircleStyles.strokeColor.replace("#", "0x"),
                    fillcolor: "0x00D1C133",
                    weight: window.AirbnbConstants.GoogleMapCircleStyles.strokeWeight
                }, r = this.staticMapHelpers.createEncodedPath(u, w);
                return p + r
            }, addStaticGoogleMap: function (p) {
                var r = this;
                ...
                if (p && p.includeNeighborhoodPolygon) {
                    q += this.getNeighborhoodEncodedPolyline()
                }
                $.ajax({
                    ...
                    dataType: "json",
                    success: function (s) {
                        r.$map.remove("img").prepend('<img src="' + s.signed_url + "\" alt='" + I18n.t("location_map") + "' />")
                    }
                }).always(function () {
                    r.isRequestingStaticMap = false
                })
            }, addNeighborhoodPolygonToOpenStreetMap: function () {
                var r = [], q = this.model.get("bounds"), p;
                if (q && q.coordinates && q.coordinates[0] && q.coordinates[0][0]) {
                    m.each(q.coordinates[0][0], function (u, s) {
                        r.push(L.latLng(u[1], u[0]))
                    });
        ...
        "../../../templates/page3/location_card.hbs": 52,
        "../../neighborhoods/neighborhoods_popover": 15,
        "../../views/shared/sliding_carousel": 48,
        "../shared/static_map_helpers": 26,
        "./location/map": 35,
        backbone: "backbone",
        o2: "o2",
        underscore: "underscore"
    ...
    35: [function (d, f, c) {
        ...
        var g = {
            initGoogleMap: function () {
                ...
                var j = k.airbnbGoogleMap(), u = j.map, i = 350, n = new window.InfoBox({
                    closeBoxURL: "",
                    pane: "floatPane",
                    alignBottom: true,
                    infoBoxClearance: new google.maps.Size(15, 50),
                    enableEventPropagation: true,
                    pixelOffset: new google.maps.Size(-1 * (i / 2 - 40), -50),
                    zIndex: 2,
                    boxStyle: {width: i + "px"}
                });
                ...
                k.on("click", function (C) {
                    if ($(C.target).hasClass("close-box")) {
                        n.close()
                    }
                });
                var A = false, r = $("#guidebook-recommendations li.user-image a"), o = r.find("img"), y = {
                    profileUrl: r.attr("href"),
                    name: o.attr("alt"),
                    profileImgUrl: o.attr("src")
                };
                var l = new google.maps.LatLngBounds();
                $("#guidebook-recommendations li.recommendation").each(function (E, H) {
                    A = true;
                    var D = $(H), G = $("span.location", D).html(), C = new google.maps.LatLng(D.data("lat"), D.data("lng")), F = new google.maps.Marker({
                        clickable: true,
                        position: C,
                        map: u,
                        icon: new google.maps.MarkerImage(D.data("img"), null, null, new google.maps.Point(11, 37))
                    });
                    google.maps.event.addListener(F, "click", function () {
                        var I = $("div.description", D);
                        I.children().css("margin-bottom", "0");
                        n.setContent((0, a["default"])({
                            title: $("h2 a", D).html(),
                            titleLink: $("h2 a", D).attr("href"),
                            hasLocation: G !== "",
                            location: G,
                            type: D.data("type"),
                            desc: I.html().trim(),
                ...
                if (A) {
                    s = j.marker.getBounds();
                    l.extend(s.getNorthEast());
                    l.extend(s.getSouthWest());
                    u.fitBounds(l);
                    google.maps.event.addListenerOnce(u, "bounds_changed", function () {
                        if (this.getZoom() > 14) {
                            this.setZoom(14)
                        }
                    })
                }
                if (q.lng() <= l.getCenter().lng()) {
                    u.panBy(-200, 0)
                }
                google.maps.event.addListenerOnce(u, "idle", this.logGoogleMapBoundsChanged.bind(this))
            }, logGoogleMapBoundsChanged: function () {
                var j = $("#map").airbnbGoogleMap().map;
                var i = this;
                google.maps.event.addListener(j, "dragend", function () {
                    i.logGoogleMapEventData(this, "drag")
                });
                google.maps.event.addListener(j, "zoom_changed", function () {
                    i.logGoogleMapEventData(this, "zoom")
                })
            }, logGoogleMapEventData: function (n, l) {
                var m = n.getBounds();
                ...
                var r = s.airbnbBingMap().map, k = 350, u = new Microsoft.Maps.Infobox(q, {
                    offset: new Microsoft.Maps.Point(-1 * k / 2 - 30, 30),
                ...
                r.entities.push(u);
                Microsoft.Maps.Events.addHandler(r, "click", function () {
                    u.setOptions({visible: false})
                });
                Microsoft.Maps.Events.addHandler(u, "click", function (A) {
                    if ($(A.originalEvent.target).hasClass("close-box")) {
                        u.setOptions({visible: false})
                    }
                });
                var o = false, n = $("#guidebook-recommendations li.user-image a"), j = n.find("img"), y = {
                    profileUrl: n.attr("href"),
                    name: j.attr("alt"),
                    profileImgUrl: j.attr("src")
                }, v = [q];
                $("#guidebook-recommendations li.recommendation").each(function (C, E) {
                    o = true;
                    var B = $(E), A = new Microsoft.Maps.Location(B.data("lat"), B.data("lng")), D = new Microsoft.Maps.Pushpin(A, {icon: B.data("img")});
                    Microsoft.Maps.Events.addHandler(D, "click", function () {
                        var F = $("div.description", B);
                        F.children().css("margin-bottom", "0");
                        u.setLocation(A);
                        u.setHtmlContent((0, a["default"])({
                            title: $("h2 a", B).html(),
                            titleLink: $("h2 a", B).attr("href"),
                            location: $("span.location", B).html(),
                            type: B.data("type"),
                            desc: F.html().trim(),
                            icon: m[B.data("type")],
                            user: y,
                    ...
                    Microsoft.Maps.Events.addHandler(D, "mouseover", function (F) {
                        r.getRootElement().style.cursor = "pointer"
                    });
                    Microsoft.Maps.Events.addHandler(D, "mouseout", function (F) {
                        r.getRootElement().style.cursor = "default"
                    });
                    r.entities.push(D);
                    v.push(A)
                });
                if (o) {
                    r.setView({bounds: Microsoft.Maps.LocationRect.fromLocations(v)});
                    Microsoft.Maps.Events.addHandler(r, "viewchangeend", function (A) {
                        if (r.getZoom() > 16) {
                            r.setView({zoom: 16})
                        }
                    })
                ...
                var v = k.airbnbOpenStreetMap(), j = v.map, i = 350, n = L.popup({
                    offset: L.point(15, 8),
                    closeButton: false,
                    maxWidth: i
                });
                k.on("click", function (D) {
                    if ($(D.target).hasClass("close-box")) {
                        j.closePopup(n)
                    }
                });
                var A = false, o = L.latLngBounds([]), r = $("#guidebook-recommendations li.user-image a"), m = r.find("img"), s, y = {
                    profileUrl: r.attr("href"),
                    name: m.attr("alt"),
                    profileImgUrl: m.attr("src")
                };
                $("#guidebook-recommendations li.recommendation").each(function (F, I) {
                    A = true;
                    var E = $(I), H = $("span.location", E).html(), D = L.latLng(E.data("lat"), E.data("lng")), G = L.marker(D, {
                        clickable: true,
                        icon: L.icon({iconUrl: E.data("img")})
                    });
                    G.addTo(j);
                    G.on("click", function () {
                        var J = $("div.description", E);
                        J.children().css("margin-bottom", "0");
                        n.setLatLng(G.getLatLng()).setContent((0, a["default"])({
                            title: $("h2 a", E).html(),
                            titleLink: $("h2 a", E).attr("href"),
                            hasLocation: H !== "",
                            location: H,
                            type: E.data("type"),
                            desc: J.html().trim(),
                ...
                if (A) {
                    s = v.marker.getBounds();
                    o.extend(s.getNorthEast());
                    o.extend(s.getSouthWest());
                    j.fitBounds(o);
                    j.addOneTimeEventListener("load", (function () {
                        if (j.getZoom() > 14) {
                            j.setZoom(14)
                        }
                    }).bind(this))
                }
                if (o.isValid() && q.lng <= o.getCenter().lng) {
                    j.panBy(L.point(-200, 0))
                }
                j.addOneTimeEventListener("focus", this.logOpenStreetMapBoundsChanged.bind(this))
            }, logOpenStreetMapBoundsChanged: function () {
                var j = $("#map").airbnbOpenStreetMap().map;
                var i = this;
                j.on("dragend", function () {
                    i.logOpenStreetMapEventData(this, "drag")
                });
                j.on("zoomend", function () {
                    i.logOpenStreetMapEventData(this, "zoom")
                })
            }, logOpenStreetMapEventData: function (n, l) {
                var m = n.getBounds();
                var k = m.getNorthEast();
                var j = m.getSouthWest();
                var i = m.getCenter();
        ...
        f.exports = g
    }, {"../../../../templates/page3/location_infobox.hbs": 53}],
    36: [function (c, a, h) {
        ...
        var g = i["default"].View.extend({
            ...
            initModal: function () {
                this.photoModal = new l.Modal("#photo-modal");
                $(".photo-trigger").on("click", (function (o) {
            ...
            initSlideshow: function () {
                ...
                o.on("load", function () {
                    if (--p === 0) {
                        s.slideshow = new f["default"]($("#photo-modal"), {
                            thumbnailWidth: r.find("li:nth-child(2)").width() + 10, onChange: function (w, v, x) {
                                var u = {index: v};
                                s.addVerifiedLabel(w, v);
                                if (typeof x === "string") {
                                    u.action = "KEYPRESS";
                                    if (x === "keyboardLeft") {
                                        u.target = "KEYBOARD_LEFT"
                                    } else {
                                        u.target = "KEYBOARD_RIGHT"
                                    }
                                } else {
                                    u.action = "CLICK";
                                    x = $(x);
                                    if (x.attr("data-slideshow-prev")) {
                                        u.target = "PREV_BUTTON"
                                    } else {
                                        if (x.attr("data-slideshow-next")) {
                                            u.target = "NEXT_BUTTON"
                                        } else {
                                            if (x.hasClass("slideshow-images")) {
                                                u.target = "SLIDESHOW_IMAGE"
                                            } else {
                                                if (x.hasClass("media-slideshow")) {
                                                    u.target = "THUMBNAIL"
                                                }
                                            }
                                        }
            ...
            logEvent: function (n) {
                Airbnb.Tracking.logEvent({
                    event_name: "P3",
                    event_data: $.extend({page: "LISTING_PAGE", section: "PHOTO_SLIDESHOW"}, n || {})
                })
            },
            ...
            onSlideshowClick: function (n) {
                var o = $(n.target);
                if (this.photoModal && !o.is(".img-contain") && o.parents(".p3-photo-social-share-widget").length === 0) {
                    this.photoModal.close();
                    this.logEvent({action: "CLICK", target: "CAROUSEL_OVERLAY"})
                }
            },
            addVerifiedLabel: function (p, n) {
                var o = $(".slideshow-thumbnails li").eq(n), q = o.find("a").data("professional");
                this.$(".slideshow-professional").toggleClass("hide", !q)
            },
            carouselPhotoClick: function (n) {
                this.slideshow.next(n.currentTarget)
            },
            handleWindowResize: function (n) {
                var q, p, o = "";
            ...
            collapseThumbnailViewport: function (n) {
                this.$(".slideshow-caption-container").toggleClass("collapsed", n)
            }
        });
        h["default"] = g;
        a.exports = h["default"]
    }, {
        "../../../templates/page3/slideshow_thumbnails.hbs": 57,
        "../globals/slideshow": 20,
        backbone: "backbone",
        o2: "o2"
    }],
    37: [function (f, g, b) {
        ...
        var c = i.View.extend({
            initialize: function (j) {
            ...
            }, events: {"click .pagination a": "handlePagination"}, handlePagination: function (k) {
                var j = $(k.currentTarget), l = $(".review-content");
                l.addClass("loading");
                $.ajax({
                    url: j.data("href"), success: function (m) {
                        l.removeClass("loading");
                ...
                return false
            }, doPersonalization: function (k) {
                if (k.should_show_review_translations) {
                ...
                if (k.review_highlights && k.review_highlights.length > 0) {
                    var j = $(".js-review-highlights-wrapper");
                    j.removeClass("hide");
                    k.review_highlights.forEach(function (l) {
                        var m = l.highlight.replace(l.keyword, "<strong>" + l.keyword + "</strong>");
                        j.append("<div>" + d.escape(m) + "</div>")
                    })
                }
            }, initReviewTranslateButton: function (k) {
                var n = $("#review-translate-button-wrapper"), m = $("#review-translate-button");
                if (n.length) {
                    var j = n.find(".review_translate_button_label"), l = n.find(".gBrandingText");
                    ...
                    $(document).on("click", "#review-translate-button", function () {
                        if ($("#review-translate-button-wrapper").data("is-translated")) {
                            ...
                            $(".review-text").each(function (p, r) {
                                var q = $(r);
                                q.html(q.data("original-text"))
                            });
                            $(".review-translation-language").each(function (p, r) {
                                var q = $(r);
                                q.html("")
                            });
                            $(".review-response-text").each(function (p, r) {
                                var q = $(r);
                                q.html(q.data("original-text"))
                            });
                            $(".review-response-language").each(function (p, r) {
                                var q = $(r);
                                q.html("")
                            })
                        } else {
                            ...
                            var o = [];
                            $(".review-text").each(function (p, q) {
                                o.push($(q).data("review-id"))
                            });
        ...
        g.exports = c
    }, {"../../lib/airbnb/expandable": 4, "../utils": 27, backbone: "backbone", underscore: "underscore"}],
    38: [function (d, f, b) {
        var c = d("underscore"), h = d("o2"), i = d("backbone"), a = d("../../views/shared/sliding_carousel"), g;
        g = i.View.extend({
            initialize: function (j) {
                this.options = j;
            ...
            }, events: {"click .carousel-chevron": "scroll", "click .listing": "logClick"}, update: function (j) {
                this.params = c.defaults(j, {checkin: "", checkout: "", guests: ""});
                ...
                var j = $(m.target), k = $(m.currentTarget);
                ...
                var p = o && o.properties, j = o && o.debug, u = {groups: []}, q, l, k, m, n, s;
                if (!p || !p.length) {
                    this.$el.addClass("hide");
                    return
                }
                ...
                s = p.length;
                while (n < s) {
                    q = {index: n / 3, cards: p.slice(n, n + 3)};
                    u.groups.push(q);
                    n += 3
                }
                if (this.carousel) {
        ...
        f.exports = g
    }, {"../../views/shared/sliding_carousel": 48, backbone: "backbone", o2: "o2", underscore: "underscore"}],
    39: [function (d, f, c) {
        d("../lib/calendar-date-span");
        ...
        Airbnb.ERF.deliverExperiment("inspectlet_on_p3", {
            inspectlet_active: function () {
                h({user_id: Airbnb.userAttributes.id})
            }, control: function () {
            }, treatment_unknown: function () {
            }
        });
        ...
        i.init();
        var g = d("o2");
        if (!g.matchMedia.is("sm")) {
            Airbnb.Tracking.registerScrollDepthTracking()
        }
    }, {
        "../inspectlet": 3,
        "../lib/calendar-date-span": 9,
        "../p3/P3BookItButtonExperiment": 16,
        "../p3/P3SafetyFeaturesSection": 17,
        "../p3/legacy_room": 22,
        "../p3/room": 23,
        "../p3/utils": 27,
        "../vendor/embedly": 43,
        "../vendor/infobox_packed": 44,
        "../views/shared/social/social_share_widget": 49,
        "../views/shared/user_flag": 50,
        o2: "o2"
    }],
    40: [function (c, f, b) {
        var d = (function () {
    ...
    41: [function (c, d, a) {
        ...
        b.extend(f.prototype, {
            _index: 0, _collection: null, _options: {onChange: false, shouldLoop: true}, _nextIndex: function () {
                var g = this._index + 1;
                return this._options.shouldLoop ? g % this._collection.length : g
            }, _prevIndex: function () {
                var h = this._index - 1, g = this._collection.length;
    ...
    42: [function (c, d, b) {
        ...
        var a = function (i, h) {
            h.forEach(function (j) {
                i[j.feature] = j.launch
            });
            return i
        };
        var g = {
            getBootstrap: function (h) {
                f = f || BootstrapData.get("trebuchet");
                if (Object.hasOwnProperty.call(f, h)) {
                    return f[h]
                } else {
                    throw new ReferenceError("" + h + " was not bootstrapped")
                }
            }, fetch: function (j, h) {
                if (!Array.isArray(j)) {
                    j = [j]
                }
                var i = j.reduce(function (l, k) {
                    return (l[k] = false, l)
                }, {});
                Airbnb.Api.get("/v1/trebuchet/multi", {
                    data: {features: j}, success: function (k) {
                        return h(a(i, k.features))
                    }, error: function () {
                        return h(i)
                    }
                })
        ...
        !(function (d) {
            $(window).on("load", function () {
                LazyLoad.js("https://cdn.embedly.com/widgets/platform.js", function () {
                    $("body").on("click", "a.embedly-btn", function (g) {
    ...
    45: [function (b, c, a) {
        window.Modernizr = (function (ac, ab, aa) {
            function F(d) {
                U.cssText = d
            }
            ...
            function B(h, g, k) {
                for (var j in h) {
                    var i = g[h[j]];
                    if (i !== aa) {
                        return k === !1 ? h[j] : D(i, "function") ? i.bind(k || g) : i
                    }
                }
                return !1
            }

            var Z = "2.8.3", Y = {}, X = ab.documentElement, W = "modernizr", V = ab.createElement(W), U = V.style, T, S = ({}).toString, R = " -webkit- -moz- -o- -ms- ".split(" "), Q = {}, P = {}, O = {}, N = [], K = N.slice, J, I = function (x, w, v, u) {
                var s, r, q, p, o = ab.createElement("div"), g = ab.body, f = g || ab.createElement("body");
                if (parseInt(v, 10)) {
                    while (v--) {
                        q = ab.createElement("div"), q.id = u ? u[v] : W + (v + 1), o.appendChild(q)
                    }
                }
            ...
            !D(H, "undefined") && !D(H.call, "undefined") ? G = function (f, d) {
                return H.call(f, d)
            } : G = function (f, d) {
                return d in f && D(f.constructor.prototype[d], "undefined")
            }, Function.prototype.bind || (Function.prototype.bind = function (f) {
                var i = this;
                if (typeof i != "function") {
                    throw new TypeError()
                }
                var h = K.call(arguments, 1), g = function () {
                ...
                var d;
                return ("ontouchstart" in ac || ac.DocumentTouch && ab instanceof DocumentTouch ? d = !0 : I(["@media (", R.join("touch-enabled),("), W, ")", "{#modernizr{top:9px;position:absolute}}"].join(""), function (f) {
                    d = f.offsetTop === 9
                }), d)
            };
            for (var M in Q) {
                G(Q, M) && (J = M.toLowerCase(), Y[J] = Q[M](), N.push((Y[J] ? "" : "no-") + J))
            }
            return (Y.addTest = function (g, f) {
                if (typeof g == "object") {
                    for (var h in g) {
                        G(g, h) && Y.addTest(h, g[h])
                    }
                } else {
                    g = g.toLowerCase();
                    if (Y[g] !== aa) {
        ...
        (function (g, i, h) {
            ...
            d = h.VerificationFlow = function (j) {
                this.options = i.extend({
                    element: null, showIntro: false, onComplete: function () {
                    }, metaData: {}
                }, j);
                this.init()
            };
            d.prototype = {
                ...
                transitionHandlers: {
                    basic_profile: function () {
                        ...
                        this.$continue.hide();
                        i.phoneNumberWidget({
                            showAddNumberInitially: true, onVerifyComplete: function () {
                        ...
                        if (this.options.profilePhotoOptions) {
                            window.ProfilePicWidget.init(this.options.profilePhotoOptions)
                        }
                        this.$continue.show()
                    }, real_name: function () {
                        this.$(".verification-flow-panel").hide();
                ...
                submitHandlers: {
                    basic_profile: function (l) {
                        if (i.trim(i("#user_profile_info_about").val()) === "") {
                            ...
                            var k = this.$panel("basic_profile").find("textarea"), j = {};
                            j[k.attr("name")] = k.val();
                            j.authenticity_token = i("#authenticity-token").data("authenticity-token");
                            i.ajax({
                                type: "POST", url: k.attr("data-url"), data: j, error: function (m) {
                                    h.mediator.emit("track:additional_desc_continue_click_error", {});
                        ...
                        if (l === "") {
                            ...
                            if (j === "") {
                                ...
                                var n = {"user[sex]": l, "user_profile_info[current_city]": j};
                ...
                nextState: function () {
                    var j = this, m = this.statesFlipped[this.currentState], n = this.submitHandlers[m], l;
                ...
                updateStep: function () {
                    var l = this.$(".verification-flow-panel:visible"), k = l.index() === -1 ? 1 : l.index() + 1, j = this.statesFlipped[this.currentState];
                    this.$(".verification-flow-step span:first").text(k);
                    if (k === this.$(".verification-flow-panel").length) {
                        this.$continue.text(I18n.t("finish"))
                    }
                ...
                trackEvent: function (m, l) {
                    var k = this.eventPrefix + m, j = i.extend({}, this.options.metaData, l, {action: m});
    ...
    47: [function (b, c, a) {
        !(function (f) {
            var d = window.Backbone.View.extend({
                initialize: function () {
                    window._.bindAll(this, "onSubmit", "itemClick");
                    this.$form = this.$("form");
                ...
                itemClick: function (j) {
                    var h = f(j.currentTarget), i = h.parent(), g;
            ...
            if (typeof c !== "undefined") {
                ...
                window.provide("views/shared/flag_widget", d)
            }
        })(jQuery)
    }, {}],
    48: [function (d, f, b) {
        var c = d("underscore"), h = d("backbone"), g, a;
        if (typeof f !== "undefined") {
            g = d("../../simple_iterator")
        } else {
            g = window.enderRequire("simple_iterator")
        }
        a = h.View.extend({
            ...
            }, events: {"click .carousel-chevron": "doScroll"}, onChange: function (j, i) {
        ...
        if (typeof f !== "undefined") {
            ...
            window.provide("shared/sliding_carousel", a)
        }
    }, {"../../simple_iterator": 41, backbone: "backbone", underscore: "underscore"}],
    49: [function (b, c, a) {
        !(function (f) {
            var d = window.Backbone.View.extend({
                networks: {
                ...
                events: {"click .share-btn": "btnClick"},
                initialize: function () {
                    this.page = this.options.page;
                    this.truncateOptions()
                },
                truncateOptions: function (j) {
                    var g = this.$el.find(".share-btn"), i = g.length, h = this.$el.find(".more-social-options"), k = this.options.maxSharingOptions || 4;
                    if (i > k + 1) {
                        f.each(g.slice(k, i), function (m, n) {
                            var o = f(n), l = o.removeAttr("data-behavior").html(o.attr("title"));
                ...
                socialTracking: function (g) {
                    var j = "social", i = this.networks[g], h = i[0], l = i[1] || "Share", k = this.page ? this.page : location.pathname;
                ...
                handleEmailShareSubmit: function (h) {
                    var g = f("#share-via-email form"), i = f(".share-error");
            ...
            if (typeof c !== "undefined") {
                ...
                window.provide("views/shared/social/social_share_widget", d)
            }
        })(jQuery)
    }, {o2: "o2"}],
    50: [function (b, c, a) {
        !(function (f) {
            ...
            if (typeof c !== "undefined") {
                ...
                d = window.enderRequire("views/shared/flag_widget")
            }
            window.UserFlag = function (g, h) {
                this.init(g, h)
            };
            f.extend(window.UserFlag.prototype, {
                init: function (g, i) {
                    var j = i.parent(), h = this;
                    ...
                    new d({
                        el: i, triggerEl: this.flagLink, afterFlagging: function () {
                            h.markAsFlagged()
                        }
                    });
                    this.bindLinks();
    ...
    51: [function (c, d, a) {
        var b = c("hbsfy/runtime");
        d.exports = b.template(function (j, q, i, p, o) {
            this.compilerInfo = [4, ">= 1.0.0"];
            ...
            function f(A, z) {
                ...
                if (y = i.offer_message) {
                    x = y.call(A, {hash: {}, data: z})
                } else {
                    y = (A && A.offer_message);
                ...
                if (y = i.completeBooking) {
                    x = y.call(A, {hash: {}, data: z})
                } else {
                    y = (A && A.completeBooking);
                    x = typeof y === l ? y.call(A, {hash: {}, data: z}) : y
                }
                w += n(x) + '\n      </a>\n      <a href="';
                if (y = i.url) {
            ...
            function s(A, z) {
                ...
                w += n(x) + "</a> - ";
                if (y = i.status_message) {
                    x = y.call(A, {hash: {}, data: z})
                } else {
                    y = (A && A.status_message);
                    x = typeof y === l ? y.call(A, {hash: {}, data: z}) : y
                }
                w += n(x) + "\n    ";
                return w
            ...
            if (!i.hasOffer) {
                g = r.call(q, g, {hash: {}, inverse: u.noop, fn: u.program(1, h, o), data: o})
            }
            if (g || g === 0) {
                m += g
            }
            ...
            if (!i.hasOffer) {
                g = r.call(q, g, {hash: {}, inverse: u.noop, fn: u.program(3, f, o), data: o})
            }
            if (g || g === 0) {
                m += g
            }
            ...
            if (!i.hasOffer) {
                g = r.call(q, g, {hash: {}, inverse: u.program(5, s, o), fn: u.noop, data: o})
            }
            if (g || g === 0) {
                m += g
            }
    ...
    52: [function (c, d, a) {
        var b = c("hbsfy/runtime");
        d.exports = b.template(function (k, w, u, p, z) {
            this.compilerInfo = [4, ">= 1.0.0"];
            ...
            function o(B, A) {
                return "neighborhood_singular"
            }

            function n(D, C) {
                var A = "", B;
                A += "\n      ";
                B = u["if"].call(D, (C == null || C === false ? C : C.index), {
                    hash: {},
                    inverse: s.noop,
                    fn: s.program(8, l, C),
                    data: C
            ...
            function y(D, C) {
                ...
                B = u.unless.call(D, (C == null || C === false ? C : C.index), {
                    hash: {},
                    inverse: s.noop,
                    fn: s.program(11, x, C),
                    data: C
            ...
            if (!u.launched) {
                m = g.call(w, m, {hash: {}, inverse: s.noop, fn: s.program(1, r, z), data: z})
            }
            if (m || m === 0) {
                v += m
            }
            ...
            if (!u.launched) {
                m = g.call(w, m, {hash: {}, inverse: s.program(3, q, z), fn: s.noop, data: z})
            }
            if (m || m === 0) {
                v += m
            }
            ...
            if (!u.t) {
                m = g.call(w, m, {hash: {}, inverse: s.noop, fn: s.program(5, o, z), data: z})
            }
            if (m || m === 0) {
                v += m
            }
    ...
    53: [function (c, d, a) {
        ...
        d.exports = b.template(function (j, q, i, p, o) {
            ...
            if (!i.hideCloseBox) {
                g = r.call(q, g, {hash: {}, inverse: s.noop, fn: s.program(1, h, o), data: o})
            }
            if (g || g === 0) {
                m += g
            }
            ...
            if (!i.hasLocation) {
                g = r.call(q, g, {hash: {}, inverse: s.noop, fn: s.program(3, f, o), data: o})
            }
            if (g || g === 0) {
                m += g
            }
            ...
            if (k = i.hostRecommendation) {
                g = k.call(q, {hash: {}, data: o})
            } else {
                k = (q && q.hostRecommendation);
                g = typeof k === l ? k.call(q, {hash: {}, data: o}) : k
            }
            m += n(g) + '</div>\n        <div>"';
            if (k = i.desc) {
    ...
    54: [function (c, d, a) {
        var b = c("hbsfy/runtime");
        d.exports = b.template(function (k, w, u, o, x) {
            this.compilerInfo = [4, ">= 1.0.0"];
            u = this.merge(u, k.helpers);
            x = x || {};
            ...
            function m(D, C) {
                ...
                y += h(A) + '" class="link-reset pull-right">\n      <i class="icon icon-arrow-right"></i>\n      ' + h((B = u.t || (D && D.t), z = {
                    hash: {},
                    data: C
                }, B ? B.call(D, "ml.preview.edit_preview", z) : s.call(D, "t", "ml.preview.edit_preview", z))) + "\n    </a>\n  ";
                return y
            }
            ...
            if (!u.suspended) {
                l = g.call(w, l, {hash: {}, inverse: r.noop, fn: r.program(1, q, x), data: x})
            }
            if (l || l === 0) {
                v += l
            }
            ...
            if (!u.suspended) {
                l = g.call(w, l, {hash: {}, inverse: r.noop, fn: r.program(3, p, x), data: x})
            }
            if (l || l === 0) {
                v += l
            }
            ...
            if (!u.suspended) {
                l = g.call(w, l, {hash: {}, inverse: r.program(5, n, x), fn: r.noop, data: x})
            }
            if (l || l === 0) {
                v += l
            }
            ...
            if (!u.showEditLink) {
                l = g.call(w, l, {hash: {}, inverse: r.noop, fn: r.program(7, m, x), data: x})
            }
            if (l || l === 0) {
                v += l
            }
    ...
    56: [function (c, d, a) {
        var b = c("hbsfy/runtime");
        d.exports = b.template(function (i, p, h, o, n) {
            this.compilerInfo = [4, ">= 1.0.0"];
            ...
            if (!h.images) {
                f = q.call(p, f, {hash: {}, inverse: r.noop, fn: r.program(1, g, n), data: n})
            }
            if (f || f === 0) {
                l += f
            }
    ...
    57: [function (c, d, a) {
        ...
        d.exports = b.template(function (j, q, i, p, o) {
            ...
            function h(A, z) {
                ...
                if (!i.first) {
                    x = r.call(A, x, {hash: {}, inverse: s.noop, fn: s.program(2, g, z), data: z})
                }
                if (x || x === 0) {
                    v += x
                }
                ...
                v += n(x) + '"\n    title="';
                if (y = i.caption_formatted) {
                    x = y.call(A, {hash: {}, data: z})
                } else {
                    y = (A && A.caption_formatted);
                    x = typeof y === l ? y.call(A, {hash: {}, data: z}) : y
                }
                v += n(x) + '">\n\n    <img alt="';
                if (y = i.caption) {
            ...
            if (!i.photoData) {
                f = r.call(q, f, {hash: {}, inverse: s.noop, fn: s.program(1, h, o), data: o})
            }
            if (f || f === 0) {
                m += f
            }
    ...
    59: [function (c, d, a) {
        ...
        d.exports = b.template(function (j, q, i, p, o) {
            ...
            function h(B, A) {
                ...
                if (!i.tooltip) {
                    y = r.call(B, y, {hash: {}, inverse: s.noop, fn: s.program(2, g, A), data: A})
                }
                if (y || y === 0) {
                    w += y
                }
            ...
            if (!i.total) {
                f = r.call(q, f, {hash: {}, inverse: s.noop, fn: s.program(4, u, o), data: o})
            }
            if (f || f === 0) {
                m += f
            }
    ...
    60: [function (b, c, a) {
        c.exports = b("handlebars/runtime")["default"]
